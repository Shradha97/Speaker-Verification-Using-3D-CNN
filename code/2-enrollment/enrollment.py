...
#print(tables.is_hdf5_file(FLAGS.development_dataset_path))
fileh = tables.open_file('./data/enrollment-evaluation_sample_dataset.hdf5', mode='r')
fileh_development = tables.open_file('./data/development_sample_dataset_speaker.hdf5', mode='r')
# Train
